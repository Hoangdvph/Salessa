                ...
                <div class="all">
                    <div class="slider">
                        <div class="owl-carousel owl-theme main">
                            <div style="background-image:  url({{ asset($product['img_thumbnail']) }})" class="item-box">
                            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="prod_info">
                    ...
                    <span class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i
                            ...
                            reviews</em></span>
                    <p><small>Product ID: {{ $product['id'] }}</small><br>{{ $product['overview'] }}</p>
                    ...
                    <form action="{{ url('cart/add') }}" method="get">
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-6">
                                <div class="price_main"><span class="new_price">{{ $product['price_sale'] }}</span><span
