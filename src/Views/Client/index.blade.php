        ...
        <div class="col-6 col-md-4 col-xl-3">
            <div class="grid_item">
                <figure>
                    ...
                    <a href="{{ url("{$product['id']}/productdetail") }}">
                        <img class="img-fluid lazy"
                            src="{{ asset($product['img_thumbnail']) }}" alt="" style="width:270px; height:270px;">
                        <img class="img-fluid lazy"
                            src="{{ asset($product['img_thumbnail']) }}"
                            data-src="img/products/shoes/1_b.jpg" alt="" style="width:270px; height:270px;">
                    </a>
                ...
                <ul>
                    ...
                    <li><a href="{{ url('cart/add') }}?quantity=1&productID={{ $product['id'] }}" class="tooltip-1" data-bs-toggle="tooltip"
